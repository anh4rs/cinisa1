...
class Admin extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->template->display('admin/admin/admin_list', $data);
    }
    ...
    public function read($id) 
    {
		...
		'email' => $row->email,
            ...
            $this->template->display('admin/admin/admin_read', $data);
        } else {
    ...
    public function create() 
    {
        ...
        $this->template->display('admin/admin/admin_form', $data);
    }
...
/* Generated by Harviacode Codeigniter CRUD Generator 2020-04-06 07:33:49 */
/* http://harviacode.com */